...
import tse.fise3.grouq.startup_poc.config.audit.AuditEventConverter;
import tse.fise3.grouq.startup_poc.domain.PersistentAuditEvent;
...
import static tse.fise3.grouq.startup_poc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
